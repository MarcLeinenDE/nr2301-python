...
- `tests/integration/test_reversible_writes.py`, hard-gated by `NR2301_WRITE_INTEGRATION=1`, covering data-roaming, available network-mode, WPS, Wi-Fi Guest/combined-vs-separate, auto-sleep timeout and timed-reboot schedule transitions with `try/finally` restoration and final read-back
